...
$this->title = 'тексты категорий';
?>

<div class="box">
    <div class="box-header">
        <h3 class="box-title">тексты категорий</h3>
    ...
    <p><k id="progress-amount">47000</k>/<k id="amount"><?= $categories_amount ?></k></p><br>
    <div class="progress">
...
<script>
    ...
    function parse(offset, limit, allAmount, parsed){
        $.ajax({
            dataType: "json",
            type : 'POST',
            url: '<?= \yii\helpers\Url::toRoute('parsing/categories-text-parsing') ?>',
