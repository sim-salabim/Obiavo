...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Парсинг текстов типов обьявлений</h3>
    ...
    <p><k id="progress-amount">0</k>/<k id="amount"><?= $placements_amount ?></k></p><br>
    <div class="progress">
...
<script>
    ...
    function parse(offset, limit, allAmount, parsed){
        $.ajax({
            dataType: "json",
            type : 'POST',
            url: '<?= \yii\helpers\Url::toRoute('parsing/placement-parsing') ?>',
