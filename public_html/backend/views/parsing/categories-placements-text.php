...
$this->title = 'тексты kategorij/placementow';
?>

<div class="box">
    <div class="box-header">
        <h3 class="box-title">тексты категорий/плайсментов</h3>
...
<script>
    ...
    function parse(offset, limit, allAmount, parsed){
        $.ajax({
            dataType: "json",
            type : 'POST',
            url: '<?= \yii\helpers\Url::toRoute('parsing/categories-placements-text-parsing') ?>',
