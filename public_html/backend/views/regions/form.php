                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-10">
                                            <?= Html::activeTextInput($region, 'domain',['class' => 'form-control'])?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-10">
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                    <?= Html::activeCheckbox($region, 'active',['label' => false, 'class' => 'input-group-addon'])?>
                                                </span>
                                                <span class="form-control">Этот регион используется на сайте</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-10">
                                            <?= Html::activeTextInput($regionText, 'name',['class' => 'form-control'])?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xs-2 col-form-label">Название в родительном падеже</label>
                                        <div class="col-xs-10">
                                            <?= Html::activeTextInput($regionText, 'name_rp',['class' => 'form-control'])?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xs-2 col-form-label">Название в предложном падеже</label>
                                        <div class="col-xs-10">
                                            <?= Html::activeTextInput($regionText, 'name_pp',['class' => 'form-control'])?>
                                        </div>
                                    </div>
                                    </div>
                                </div>
