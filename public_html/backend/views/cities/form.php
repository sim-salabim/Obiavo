                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-10">
                                            <?= Html::activeTextInput($city, 'domain',['class' => 'form-control'])?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-10">
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                    <?= Html::activeCheckbox($city, 'active',['label' => false, 'class' => 'input-group-addon'])?>
                                                </span>
                                                <span class="form-control">Этот город используется на сайте</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-10">
                                            <?= Html::activeTextInput($cityText, 'name',['class' => 'form-control'])?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xs-2 col-form-label">Название в родительном падеже</label>
                                        <div class="col-xs-10">
                                            <?= Html::activeTextInput($cityText, 'name_rp',['class' => 'form-control'])?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xs-2 col-form-label">Название в предложном падеже</label>
                                        <div class="col-xs-10">
                                            <?= Html::activeTextInput($cityText, 'name_pp',['class' => 'form-control'])?>
                                        </div>
                                    </div>
                                    </div>
                                </div>
