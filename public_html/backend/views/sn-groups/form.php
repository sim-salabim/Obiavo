...
$current_category_value['id'] = ($sn_group->categories_id) ? $sn_group->categories_id : null;
$current_category_value['title'] = ($sn_group->categories_id) ? $sn_group->category->_text->name : null;
$items = [
    'saveUrl' => $toUrl,
    'rows' => [
        [
            ...
            'attributes' => [
                ...
                ['name' => 'categories_id','type' => Form::SEARCH_AUTOCOMPLETE,'label' => 'Категория', 'model_name' => 'SocialNetworksGroups', 'model'=>$sn_group, 'url' => 'categories/search ', 'placeholder' => 'Начните печатать название категории...', 'current_value' => $current_category_value, 'input_id' => 'socialnetworksgroups-categories_id'],
