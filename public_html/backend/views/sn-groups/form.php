    ...
    'rows' => [
        [
            ...
            'attributes' => [
                ...
                ['name' => 'consumer_key','type' => Form::INPUT_TEXT,'label' => 'Consumer key','model'=>$sn_group,'label_desc' => 'Только для Twitter. Публичный ключ приложения для ok.ru' ],
                ['name' => 'consumer_secret','type' => Form::INPUT_TEXT,'label' => 'Consumer secret','model'=>$sn_group,'label_desc' => '"Consumer secret" для Twitter. Секретный ключ приложения для ok.ru' ],
